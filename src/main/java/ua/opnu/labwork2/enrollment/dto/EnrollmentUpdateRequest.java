...
@Schema(description = "Дані для повного оновлення запису студента на курс")
public record EnrollmentUpdateRequest(
        ...
        @Schema(description = "Поточний прогрес проходження курсу у відсотках", example = "70", requiredMode = Schema.RequiredMode.REQUIRED)
